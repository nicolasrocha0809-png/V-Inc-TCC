...
class JanelaPrincipal(QMainWindow):
    def __init__(self, supabase_client=None):
        ...
        self.btn_historico.clicked.connect(lambda: self.mudar_tela(4))
        
        self.btn_config = QPushButton("Configurações"); self.btn_config.setObjectName("menu_btn")
        self.btn_config.clicked.connect(lambda: self.mudar_tela(5))
        
        for btn in [self.btn_inicio, self.btn_comandos, self.btn_historico, self.btn_config]:
