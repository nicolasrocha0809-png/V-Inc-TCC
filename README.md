# 👁️ V-Inc: Assistente de Voz versão inicial de teste
...
* **Recuperação de Senha por E-mail:** Envio automatizado em segundo plano de códigos de verificação em formato HTML através do servidor SMTP do Gmail.
...
5. Configure suas credenciais de e-mail (Gmail e Senha de App) no topo do arquivo `login.py`.
6. Execute o sistema:
   `python login.py`